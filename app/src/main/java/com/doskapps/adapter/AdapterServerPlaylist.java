...
import com.doskapps.item.ItemServerPlayList;
...
public class AdapterServerPlaylist extends RecyclerView.Adapter<AdapterServerPlaylist.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(Constant.columnWidth, (int) (Constant.columnWidth / 1.5));
